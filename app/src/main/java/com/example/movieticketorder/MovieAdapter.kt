...
class MovieAdapter (private var MovieList:ArrayList<Movie>): RecyclerView.Adapter<MovieAdapter.MovieViewHolder>(){


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MovieAdapter.MovieViewHolder {
        val MovieView = LayoutInflater.from(parent.context).inflate(R.layout.moviecard,parent,false)
    ...
    override fun onBindViewHolder(holder: MovieViewHolder, position: Int) {
        ...
        Glide.with(holder.itemView.context).load(currentMovie.imageMovie).fitCenter().into(holder.imageMovie)
    ...
    class MovieViewHolder(MovieView: View):RecyclerView.ViewHolder(MovieView){
        val imageMovie : ImageView = MovieView.findViewById(R.id.image)
        val titleMovie : TextView = MovieView.findViewById(R.id.judul)
    }
}